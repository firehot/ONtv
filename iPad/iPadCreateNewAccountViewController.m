...
@interface iPadCreateNewAccountViewController() <UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate>
...
@implementation iPadCreateNewAccountViewController
...
- (void)layoutHeaderView
{
    ...
    backBtn.frame = CGRectMake(25, 25, CGRectGetWidth(backBtn.frame), CGRectGetHeight(backBtn.frame));
    backBtn.autoresizingMask=UIViewAutoresizingFlexibleRightMargin;
...
- (void)layoutFooterView
{
	...
	createButton.frame = CGRectMake(floorf(0.5f*(footerView.bounds.size.width - 400)), 5, 400, 35); //70
    ...
    createButton.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
	...
	UILabel *mandatoryLabel = [[UILabel alloc]initWithFrame:CGRectMake(40, CGRectGetMaxY(createButton.frame)+10, footerView.bounds.size.width-20.0f, suggestedSize.height)];
